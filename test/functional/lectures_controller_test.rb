...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { end_time: @lecture.end_time, held_date: @lecture.held_date, start_time: @lecture.start_time }
    end
  ...
  test "should update lecture" do
    put :update, id: @lecture, lecture: { end_time: @lecture.end_time, held_date: @lecture.held_date, start_time: @lecture.start_time }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
